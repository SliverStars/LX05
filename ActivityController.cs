...
namespace Service.Controllers
{
    ...
    public class ActivityController : Controller
    {
        ...
        public ActionResult Get(int id)
        {
            ...
            result.activityIntroduction = result.a = activityIntroduction.Replace("src=\"",$"src =\"https://{HttpContext.Request.Host.Value}/");
            if (result != null)
                return Json(Result.Ok(result));
            else
        ...
        [HttpPut("{id}")]
        public ActionResult ipImg(int id,List<IFormFile> files)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var n = DAL.Activity.Instance.UpImg(activity);
                    if (n > 0)
